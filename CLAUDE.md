...
- Do not set `Camera2D.ignore_rotation = false` when you also need a fixed (axis-aligned) camera mode. Toggle it per-frame based on the active mode. *(see docs/claude-camera.md)*
