...
const PROPERTY_DEFS: Array[Dictionary] = [
	...
	{"group": "Enemy Spawning", "class": "EnemySpawnerComponent", "name": "spawn_interval_min",
		"type": TYPE_FLOAT, "default": 0.6, "min": 0.05, "max": 10.0, "step": 0.05},
	{"group": "Enemy Spawning", "class": "EnemySpawnerComponent", "name": "max_enemies_max",
		"type": TYPE_INT, "default": 60, "min": 1, "max": 300, "step": 1},

	# ── Enemy Scaling ─────────────────────────────────────────────────────────────
	{"group": "Enemy Scaling", "class": "EnemySpawnerComponent", "name": "enemy_health_mult_max",
		"type": TYPE_FLOAT, "default": 2.0, "min": 1.0, "max": 10.0, "step": 0.1},
	{"group": "Enemy Scaling", "class": "EnemySpawnerComponent", "name": "enemy_damage_mult_max",
		"type": TYPE_FLOAT, "default": 1.6, "min": 1.0, "max": 10.0, "step": 0.1},
	{"group": "Enemy Scaling", "class": "EnemySpawnerComponent", "name": "enemy_speed_mult_max",
		"type": TYPE_FLOAT, "default": 1.3, "min": 1.0, "max": 5.0, "step": 0.05},
	...
	{"group": "Level Generation", "class": "ProcGenLevelComponent", "name": "arena_width_max",
		"type": TYPE_INT, "default": 60, "min": 10, "max": 200, "step": 1},
	{"group": "Level Generation", "class": "ProcGenLevelComponent", "name": "arena_height_max",
		"type": TYPE_INT, "default": 44, "min": 10, "max": 200, "step": 1},
	...
	{"group": "Level Generation", "class": "ProcGenLevelComponent", "name": "obstacle_density_max",
		"type": TYPE_FLOAT, "default": 0.42, "min": 0.0, "max": 1.0, "step": 0.01},
	...
	{"group": "Sector Objective", "class": "LevelObjectiveComponent", "name": "kill_quota_max",
		"type": TYPE_INT, "default": 60, "min": 1, "max": 500, "step": 1},
	...
	# ── Boss ──────────────────────────────────────────────────────────────────────
	{"group": "Boss", "class": "Boss", "name": "boss_health",
		"type": TYPE_FLOAT, "default": 500.0, "min": 50.0, "max": 10000.0, "step": 50.0},
	{"group": "Boss", "class": "Boss", "name": "boss_health_max",
		"type": TYPE_FLOAT, "default": 2000.0, "min": 100.0, "max": 50000.0, "step": 100.0},
	{"group": "Boss", "class": "Boss", "name": "bullet_damage",
		"type": TYPE_FLOAT, "default": 12.0, "min": 1.0, "max": 200.0, "step": 1.0},
	{"group": "Boss", "class": "Boss", "name": "bullet_speed",
		"type": TYPE_FLOAT, "default": 350.0, "min": 100.0, "max": 1200.0, "step": 10.0},
	{"group": "Boss", "class": "Boss", "name": "max_speed",
		"type": TYPE_FLOAT, "default": 120.0, "min": 20.0, "max": 600.0, "step": 10.0},
	{"group": "Boss", "class": "BossAIComponent", "name": "activation_delay",
		"type": TYPE_FLOAT, "default": 1.5, "min": 0.0, "max": 10.0, "step": 0.1},
	{"group": "Boss", "class": "BossAIComponent", "name": "attack_cooldown",
		"type": TYPE_FLOAT, "default": 3.5, "min": 0.5, "max": 15.0, "step": 0.1},
	{"group": "Boss", "class": "BossAIComponent", "name": "attack_cooldown_min",
		"type": TYPE_FLOAT, "default": 1.2, "min": 0.2, "max": 10.0, "step": 0.1},
	{"group": "Boss", "class": "BossAIComponent", "name": "preferred_distance",
		"type": TYPE_FLOAT, "default": 400.0, "min": 50.0, "max": 1200.0, "step": 25.0},
	{"group": "Boss", "class": "BossAIComponent", "name": "radial_bullet_count",
		"type": TYPE_INT, "default": 12, "min": 4, "max": 48, "step": 1},
	{"group": "Boss", "class": "BossAIComponent", "name": "radial_bullet_count_max",
		"type": TYPE_INT, "default": 20, "min": 4, "max": 64, "step": 1},
	{"group": "Boss", "class": "BossAIComponent", "name": "spread_bullet_count",
		"type": TYPE_INT, "default": 5, "min": 1, "max": 20, "step": 1},
	{"group": "Boss", "class": "BossAIComponent", "name": "spread_bullet_count_max",
		"type": TYPE_INT, "default": 9, "min": 1, "max": 32, "step": 1},
	{"group": "Boss", "class": "BossAIComponent", "name": "spiral_bullet_count",
		"type": TYPE_INT, "default": 24, "min": 8, "max": 96, "step": 1},
	{"group": "Boss", "class": "BossAIComponent", "name": "spiral_bullet_count_max",
		"type": TYPE_INT, "default": 48, "min": 8, "max": 192, "step": 1},
	{"group": "Boss", "class": "BossAIComponent", "name": "spiral_interval",
		"type": TYPE_FLOAT, "default": 0.07, "min": 0.01, "max": 0.5, "step": 0.01},
	{"group": "Boss", "class": "LevelObjectiveComponent", "name": "miniboss_sector",
		"type": TYPE_INT, "default": 5, "min": 1, "max": 10, "step": 1},
...
const _SEED_SCENES: Array[String] = [
	...
	"res://Components/BossAIComponent.tscn",
